...
#the import keyword imports the given pre-defined libraries tac, readfile from lib.helper
TEXT = None
...
print(tac(TEXT))
# The print function will activate the tac command and pass the TEXT to tac command which belongs to the linux shell
# The tac command will concatenate and print files in reverse
